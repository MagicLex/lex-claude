...
Read these files in `$CLAUDE_PROJECT_DIR` (skip missing): `CLAUDE.md`, `docs/PHILOSOPHY.md`, `docs/CONTEXT.md`, `docs/PRINCIPLES.md`, `docs/INVARIANTS.md`, `docs/OPS.md`, `docs/TODO.md`.
